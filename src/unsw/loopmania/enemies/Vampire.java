...
public class Vampire extends BasicEnemy {
    ...
    /**
     * Movement taken for a Vampire, vampire generally moves away from campfire
     */
    ...
    /**
     * Vampire trance count is reduced, and a message is poped if Vampire exits
     * trance
     * 
     * @precondition Vampire is Tranced
    ...
    /**
     * Assert if Vampire is dead or tranced to prevent being attacked by Character /
     * Soldier / enemy
     * 
     * @return Boolean
     */
    ...
    public Boolean setVampirePosition(int vampireCount, int vampireCaslteCount, List<Building> buildingEntities) {
        Pair<Integer, Integer> vampirePos = possiblyGetVampireSpawnPosition(vampireCount, vampireCaslteCount,
                buildingEntities);
        if (vampirePos != null) {
     ...
     */
    public Pair<Integer, Integer> possiblyGetVampireSpawnPosition(int vampireCount, int vampireCastleCount,
