...
public class Soldier extends MovingEntity {
    ...
    String ImageUrl = "src/images/deep_elf_master_archer.png";
    String ToolTipString = "Soldier\nHelp you fight the enemies in this durgeon!\nLow HP, Low Damage";
    ...
    /**
     * Soldier move to the next position, and strictly follows character; by taking
     * the previous position, if soldier at previous position is dead;
     * 
     * @param int n
     */
